...
abstract contract FrontEndRewarder is AcranaAccessControlled {
    /* ========= STATE VARIABLES ========== */
    ...
    IERC20 internal immutable acrn; // reward token

    constructor(IAcranaAuthority _authority, IERC20 _acrn) AcranaAccessControlled(_authority) {
        acrn = _acrn;
    }
    ...
    function getReward() external {
        ...
        acrn.transfer(msg.sender, reward);
    }
