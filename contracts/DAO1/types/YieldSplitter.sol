...
import {IgACRN} from "../interfaces/IgACRN.sol";
import {SafeERC20} from "../libraries/SafeERC20.sol";

/**
    @title IACRNIndexWrapper
    @notice This interface is used to wrap cross-chain oracles to feed an index without needing IsACRN, 
    while also being able to use sACRN on mainnet.
 */
interface IACRNIndexWrapper {
    function index() external view returns (uint256 index);
}

/**
    @title YieldSplitter
    @notice Abstract contract that allows users to create deposits for their gACRN and have
            ...
            emergency controls, sending and recieving gACRN is up to the implementation of
...
abstract contract YieldSplitter {
    ...
    IACRNIndexWrapper public immutable indexWrapper;

    struct DepositInfo {
        uint256 id;
        address depositor;
        uint256 principalAmount; // Total amount of sAcrn deposited as principal, 9 decimals.
        uint256 agnosticAmount; // Total amount deposited priced in gAcrn. 18 decimals.
    }
    ...
    /**
        @notice Constructor
        @param indexWrapper_ Address of contract that will return the sACRN to gACRN index. 
                             On mainnet this will be sACRN but on other chains can be an oracle wrapper.
    */
    constructor(address indexWrapper_) {
        indexWrapper = IACRNIndexWrapper(indexWrapper_);
    }

    /**
        @notice Create a deposit.
        @param depositor_ Address of depositor
        @param amount_ Amount in gAcrn. 18 decimals.
    */
    ...
    /**
        @notice Add more gAcrn to the depositor's principal deposit.
        @param id_ Id of the deposit.
        @param amount_ Amount of gAcrn to add. 18 decimals.
    */
    ...
    /**
        ...
        @param id_ Id of the deposit.
        @param amount_ Amount of gACRN to withdraw.
    */
    ...
    /**
        ...
        @param id_ Id of the deposit.
        @return amountWithdrawn : amount of gACRN withdrawn. 18 decimals.
    */
    ...
    /**
        @notice Redeem excess yield from your deposit in sACRN.
        @param id_ Id of the deposit.
        @return amountRedeemed : amount of yield redeemed in gACRN. 18 decimals.
    */
    ...
    /**
        ...
        @param id_ Id of the deposit.
        @dev Internally for accounting reasons principal amount is stored in 9 decimal ACRN terms. 
        Since most implementations will work will gACRN, principal here is returned externally in 18 decimal gACRN terms.
        @return principal : amount of principal that was deleted. in gACRN. 18 decimals.
        @return agnosticAmount : total amount of gACRN deleted. Principal + Yield. 18 decimals.
    */
    ...
    /**
        ...
        @return uint256 amount of yield in gACRN. 18 decimals.
     */
    ...
    /**
        @notice Convert flat sACRN value to agnostic gACRN value at current index
        @dev Agnostic value earns rebases. Agnostic value is amount / rebase_index.
             1e18 is because sACRN has 9 decimals, gACRN has 18 and index has 9.
     */
    ...
    /**
        @notice Convert agnostic gACRN value at current index to flat sACRN value
        @dev Agnostic value earns rebases. sACRN amount is gACRNamount * rebase_index.
             1e18 is because sACRN has 9 decimals, gACRN has 18 and index has 9.
     */
