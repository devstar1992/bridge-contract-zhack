...
contract gACRN is IgACRN, ERC20 {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(address _migrator, address _sACRN) ERC20("Governance ACRN", "gACRN", 18) {
     ...
     * @param _sACRN address
     */
    function migrate(address _staking, address _sACRN) external override onlyApproved {
        ...
        require(_sACRN != address(0), "Zero address found");
        sACRN = IsACRN(_sACRN);
    }
    ...
    /**
     * @notice pull index from sACRN token
     */
    ...
    /**
        @notice converts gACRN amount to ACRN
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts ACRN amount to gACRN
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gACRN::getPriorVotes: not yet determined");
