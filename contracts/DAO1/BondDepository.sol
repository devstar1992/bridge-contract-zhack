...
/// @title Acrana Bond Depository V2
/// @author Zeus, Indigo
/// Review by: JeffX

contract AcranaBondDepositoryV2 is IBondDepository, NoteKeeper {
    /* ======== DEPENDENCIES ======== */
    ...
    constructor(
        IAcranaAuthority _authority,
        IERC20 _acrn,
        IgACRN _gacrn,
        IStaking _staking,
        ITreasury _treasury
    ) NoteKeeper(_authority, _acrn, _gacrn, _staking, _treasury) {
        // save gas for users by bulk approving stake() transactions
        _acrn.approve(address(_staking), 1e45);
    }
     ...
     * @return payout_     the amount of gACRN due
        ...
        )
    {
         ...
         * price = quote tokens : acrn (i.e. 42069 BUSD : ACRN)
         *
         * 1e18 = ACRN decimals (9) + price decimals (9)
         */
         ...
         *
         * this is either the number of ACRN that the market can sell
        ...
        // purchased, and how much ACRN has been sold
    ...
    function _tune(uint256 _id, uint48 _time) internal {
        ...
        if (_time >= meta.lastTune + meta.tuneInterval) {
            ...
            // acrn decimals (9) + price decimals (9)
             ...
             * is 10,000 ACRN. max payout would be 1,000 ACRN (10,000 * 1 / 10).
             */
     ...
     * @param _market      [capacity (in ACRN or quote), initial price / ACRN (9 decimals), debt buffer (3 decimals)]
    ...
    function create(
         ...
         *
         * 1e18 = acrn decimals (9) + initial price decimals (9)
         */
        uint64 targetDebt = uint64(_booleans[0] ? ((_market[0] * 1e18) / _market[1]) / 10**decimals : _market[0]);

        /*
         * max payout is the amount of capacity that should be utilized in a deposit
         * interval. for example, if capacity is 1,000 ACRN, there are 10 days to conclusion,
         * and the preferred deposit interval is 1 day, max payout would be 100 ACRN.
         */
        ...
        emit CreateMarket(id_, address(acrn), address(_quoteToken), _market[1]);
    }
     ...
     * @param _id          ID of market
     * @return             price for market in ACRN decimals
     *
     ...
     * @param _id          ID of market
     * @return             amount of ACRN to be paid in ACRN decimals
     *
     * @dev 1e18 = acrn decimals (9) + market price decimals (9)
     */
     ...
     * @param _id          ID of market
     * @return             current debt for market in ACRN decimals
     */
     ...
     * @param _id          ID of market
     * @return             control variable for market in ACRN decimals
     */
